...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   InputRealPtrsType u_dc          = ssGetInputPortRealSignalPtrs(S, 0); // Zwischenkreisspannung
   InputRealPtrsType u_soll_betrag = ssGetInputPortRealSignalPtrs(S, 1); // Betrag des Raumzeigers
   ...
   //transformation  
   svm(*u_dc[0],  *u_soll_betrag[0],  *gamma[0],  &out_svm);
